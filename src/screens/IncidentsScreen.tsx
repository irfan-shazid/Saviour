...
export function IncidentsScreen() {
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={
        <View>
          <ScreenHeader title="Incident history" subtitle="Everything Saviour has logged, newest first." />
          {incidents.length > 0 && (
            <>
              ...
              <Button
                ...
                style={{ alignSelf: 'flex-start', marginBottom: spacing(2), paddingHorizontal: spacing(2) }}
              />
            </>
          )}
        </View>
